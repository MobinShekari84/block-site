export const projects = [
  {
    ...
    coverImage: '/assets/villa/Khane-Darya-No.199/exterior-design/facade.webp',
    narrativeImage: '/assets/villa/Khane-Darya-No.199/exterior-design/facade_1.webp',
    specs: {
    ...
    heroTheme: 'light',
    spatialPlan: {
      planImageUrl: '/assets/villa/Khane-Darya-No.199/documents/ground-floor.webp',
      aspectRatio: '1600 / 1200',
      hotspots: [
        { id: 1, x: 30, y: 30, rot: 45, title: { en: 'Living Space', fa: 'فضای نشیمن' }, zone: { en: 'Interior', fa: 'داخلی' }, renderUrl: '/assets/villa/Khane-Darya-No.199/exterior-design/facade_1.webp' },
        { id: 2, x: 70, y: 60, rot: 90, title: { en: 'Back Garden', fa: 'حیاط پشتی' }, zone: { en: 'Exterior', fa: 'خارجی' }, renderUrl: '/assets/villa/Khane-Darya-No.199/exterior-design/facade_1.webp' }
      ]
    }
  },
  {
    ...
    coverImage: '/assets/villa/Sisangan-Mazandaran/exterior-design/facade_2.webp',
    narrativeImage: '/assets/villa/Sisangan-Mazandaran/exterior-design/entrance.webp',
    specs: {
  ...
  },
  {
    ...
    coverImage: '/assets/villa/Damas-Villa/exterior-design/facade_1.webp',
    narrativeImage: '/assets/villa/Damas-Villa/exterior-design/facade.webp',
    specs: {
    ...
    heroTheme: 'light',
    spatialPlan: {
      planImageUrl: '/assets/villa/Damas-Villa/documents/ground-floor.webp',
      aspectRatio: '1755 / 2482',
      hotspots: [
        { id: 1, x: 25, y: 35, rot: 45, title: { en: 'Front Approach', fa: 'نمای ورودی' }, zone: { en: 'Exterior', fa: 'خارجی' }, renderUrl: '/assets/villa/Damas-Villa/exterior-design/facade_1.webp' },
        { id: 2, x: 50, y: 50, rot: 90, title: { en: 'Interior Space', fa: 'فضای داخلی' }, zone: { en: 'Interior', fa: 'داخلی' }, renderUrl: '/assets/villa/Damas-Villa/exterior-design/facade_1.webp' },
        { id: 3, x: 75, y: 65, rot: 135, title: { en: 'Arched Window', fa: 'پنجره قوسی' }, zone: { en: 'Lounge', fa: 'نشیمن خصوصی' }, renderUrl: '/assets/villa/Damas-Villa/exterior-design/facade_1.webp' }
      ]
    }
  },
  {
    ...
    coverImage: '/assets/villa/Sarziarate-Villa/exterior-design/facade.webp',
    narrativeImage: '/assets/villa/Sarziarate-Villa/exterior-design/facade_1.webp',
    specs: {
  ...
  },
  {
    ...
    coverImage: '/assets/renovation/Namdar-Building-Renovation/interior-design/living-room.webp',
    narrativeImage: '/assets/renovation/Namdar-Building-Renovation/interior-design/bathroom.webp',
    specs: {
  ...
  },
  {
    ...
    coverImage: '/assets/renovation/Office-Renovation/interior-design/office.webp',
    narrativeImage: '/assets/renovation/Office-Renovation/interior-design/office_1.webp',
    specs: {
  ...
  },
  {
    ...
    coverImage: '/assets/renovation/Sheikh-Bahayi-Renovation/interior-design/salon.webp',
    narrativeImage: '/assets/renovation/Sheikh-Bahayi-Renovation/interior-design/bedroom_1.webp',
    specs: {
      area: { en: 'Unknown sqm', fa: 'نامشخص' },
      status: { en: 'Completed', fa: 'تکمیل شده' },
      materials: { en: 'Wood, Concrete', fa: 'چوب، بتن' },
